...
export type GameEvent = 
  ...
  | { type: 'player.died'; payload: PlayerDiedEvent }
  | { type: 'game.phase.changed'; payload: GamePhaseChangedEvent }
  | { type: 'monster.spawned'; payload: MonsterSpawnedEvent }
  | { type: 'effect.applied'; payload: EffectAppliedEvent }
  | { type: 'effect.removed'; payload: EffectRemovedEvent };
...
export type CreateGameInput = Pick<GameState, 'rules'> & { hostPlayerId: string };
...
export function isValidAction(obj: any): obj is PlayerAction {
