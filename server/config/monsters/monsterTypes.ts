...
import { MonsterTypes, AttackPatterns, MonsterType, AttackPattern } from './types.js';

const monsterTypes: MonsterTypes = {
  1: {
    type: 'wildBeast',
    name: 'Wild Beast',
    emoji: '🐺',
 ...
 */
const attackPatterns: AttackPatterns = {
  single: {
    targetsCount: 1,
...
export { monsterTypes, attackPatterns, getMonsterForLevel, getAttackPattern };