...
const raceAttributes = {
  Human: {
    ...
    compatibleClasses: ['Warrior', 'Wizard', 'Assassin', 'Rogue', 'Priest', 'Gunslinger'],
    description: 'Adaptable and versatile, humans can learn abilities from other classes.'
  },
  Dwarf: {
    hpModifier: 1.2,       // More HP
    armorModifier: 2.0,    // Significant armor bonus
    damageModifier: 0.9,   // Slightly reduced damage
    compatibleClasses: ['Warrior', 'Pyromancer', 'Priest', 'Oracle', 'Shaman', 'Gunslinger'],
    description: 'Hardy and resilient, dwarves have stone armor that degrades with damage taken.'
  },
  Elf: {
    hpModifier: 0.9,       // Less HP
    armorModifier: 0.0,    // No armor bonus
    damageModifier: 1.1,   // Increased damage
    compatibleClasses: ['Wizard', 'Assassin', 'Rogue', 'Seer', 'Tracker', 'Druid'],
    description: 'Quick and perceptive, elves can reveal if a target is a warlock.'
  },
  Orc: {
    hpModifier: 1.1,       // More HP
    armorModifier: 0.0,    // No armor bonus
    damageModifier: 1.2,   // Significantly increased damage
    compatibleClasses: ['Pyromancer', 'Oracle', 'Seer', 'Shaman', 'Tracker', 'Druid'],
    description: 'Fierce and mighty, orcs can boost their attack power at the cost of health.'
  },
  Satyr: {
    hpModifier: 1.0,       // Standard HP
    armorModifier: 0.0,    // No armor bonus
    damageModifier: 1.0,   // Standard damage
    compatibleClasses: ['Rogue', 'Oracle', 'Seer', 'Shaman', 'Tracker', 'Druid'],
  ...
  Skeleton: {
    ...
    armorModifier: 0.0,    // No armor bonus
    damageModifier: 1.0,   // Standard damage
    compatibleClasses: ['Warrior', 'Pyromancer', 'Wizard', 'Assassin', 'Priest', 'Gunslinger'],
    description: 'Undead and resilient, skeletons can return to life once after being defeated.'
  }
};
