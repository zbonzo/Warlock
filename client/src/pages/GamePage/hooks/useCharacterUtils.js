 ...
 */
export const useCharacterUtils = (me, players) => {
  /**
   * Convert text to Zalgo text (corrupted appearance)
   * @param {string} text - Text to convert
   * @returns {string} Zalgo-ified text
   */
  const toZalgo = useCallback((text) => {
    const zalgoAbove = [
      '\u030D', '\u030E', '\u0304', '\u0305', '\u033F', '\u0311', '\u0306', '\u0310',
      '\u0352', '\u0357', '\u0351', '\u0307', '\u0308', '\u030A', '\u0342', '\u0343',
      '\u0344', '\u034A', '\u034B', '\u034C', '\u0303', '\u0302', '\u030C', '\u0350',
   ...
   * @returns {string} Formatted character title
   */
  const getCharacterTitle = useCallback(() => {
